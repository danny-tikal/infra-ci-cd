...
resource "aws_autoscaling_group" "workers" {
  ...
  warm_pool {
    pool_state                  = "Stopped"
    min_size                    = lookup(var.worker_groups[count.index], "warm_pool_min", local.workers_group_defaults["warm_pool_min"])
    max_group_prepared_capacity = lookup(var.worker_groups[count.index], "warm_pool_max", local.workers_group_defaults["warm_pool_max"])
  }
  ...
  #   "warm_pool_min_size",
  #   2)  
  #   max_group_prepared_capacity = lookup(
  #   var.worker_groups[count.index],
